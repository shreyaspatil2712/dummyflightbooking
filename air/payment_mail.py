def payment(board):
    ans = input("How would you like to pay?:" )
    if ans == "netbanking":
        ...
        if ans3 == "y" :
            ...
            counter1 = str(seatsn)
            cost1 = str(cost)
            mainbody = "Dear Customer, Your booking's' for  " + date + " have been confirmed. " + counter1 + " seats have been booked. Total cost of your booking is  " + cost1  + "$"
